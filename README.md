...
Copy `templates/class-guide-template.md`, then verify every skill name against a current Hyperioxes build before filling it in. See the corrections log in `CLAUDE.md` for why this matters.
