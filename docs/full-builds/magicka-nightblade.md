...
- **Dark Cloak** — *Nightblade > Shadow* (other morph of Shadow Cloak) — trades the invisibility for a **burst heal on cast that can't be broken by AoE/detection**; maximum-survivability swap over Shadowy Disguise
...
At CP 1200 you have ~400 points per color; at 1800, ~600. Follow each table **top to bottom** — star costs vary, so trust the order, not the math. Stars marked **SLOT** go in your 4 active slots per tree; everything else works passively once purchased.
...
| 7 | Eldritch Insight | buy max (20) | max magicka (your whole pool) |
| 8 | Tireless Discipline | buy max (20) | max stamina (dodge/block/break-free) |
...
| 14 | **Reaving Blows** | buy (50), swap option | heals off direct damage — stacks with Pale Order *and* Swallow Soul for absurd solo healing |
| 15 | Thaumaturge | buy (50), swap option | in for Wrathful Strikes on DoT/HoT-heavy fights (Swallow Soul HoT, Refreshing Path) |
...
| 4 | **Expert Evasion** | **SLOT** (50) | cheaper, stronger dodge rolls — your melee panic button |
...
| 11 | Siphoning Spells | buy (50), swap option | extra magicka return if a fight out-drains your heals |
