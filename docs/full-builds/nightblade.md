...
| 4. Dark Cloak (*Shadow*) ⚠️ — the burst heal morph of Shadow Cloak | 4. Resolving Vigor (morph of Vigor, *Alliance War → Assault*) — heal-over-time |
...
!!! warning "These bars are household-constructed, not copied from a published build"
    ...
    **Nearest published reference:** Alcast's U50/U51 Stamina Nightblade PvP build. Compare against it before you spend gold, and treat these bars as a starting point rather than a parse-tested list. **Update 51 (28 Sept 2026) reworks the Major/Minor buff system, Mundus Stones and class passives** — re-verify after it lands.
