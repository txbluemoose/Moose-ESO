# Pure Stamina Warden Master Guide — Update 50
...
|---|---|---|---|
| Default | **Wild Adaptation** (333 Wpn/Spell Dmg per status effect on target, max 1665) | **Glacial Obstinance** (Bond with Nature also triggers on Winter's Embrace casts; +15% Wpn/Spell Dmg for 10s if at full health after the heal) | **Green-Keeper's Hide** replaces Glacial Obstinance if you need survivability (−3% damage taken per status effect on your attacker, max −15%) |
...
**Race:** Nord for hard content (Rugged ≈ 5–7% mitigation); Khajiit/Dark Elf +3.5% damage
...
| 7 | **Bloody Renewal** | **SLOT** (50) | 1500 stamina on kills |
...
## 6. SHOPPING LIST
1. **Scribing** (Gold Road) — Wield Soul, Soul Burst, Ulfsild's are three of your twelve slots
2. **Aerie's Cry** — Infinite Archive (Warden class set)
3. **Crushing Wall Ice Staff** — vet Maelstrom Arena
4. **Slimecraw** — vet Wayrest Sewers I
