...
| Term | What it means |
|---|---|
| **CP** | Champion Points — the account-wide passive point system the roadmaps spend |
| **PvE / PvP** | Player-vs-Environment (monsters) / Player-vs-Player (Cyrodiil, Battlegrounds) |
| **DoT / AoE** | Damage over Time / Area of Effect |
| **vet / HM** | Veteran (harder) mode / Hard Mode |
| **IA** | Infinite Archive — endless two-player mode; drops the class sets |
| **vMA** | Veteran Maelstrom Arena — solo arena; drops the Crushing Wall weapons |
| **CoA II** | Veteran City of Ash II — dungeon that drops Valkyn Skoria |
| **BG** | Battleground — small-scale instanced PvP |

## Mechanics & systems

| Term | What it means |
|---|---|
| **Class Mastery** | Update 50 system: pure-class characters pick 2 bonus class passives. Subclassing disables it — which is why both characters stay pure class |
| **Light-attack weaving** | Slipping a light attack between each ability cast for a big chunk of free damage |
