...
| Boots | **Light** | Divines | Stamina | Deadly Strike |
...
- **Grave Lord:** all — three skills live here; **Death Gleaning** (resources when a damaged enemy dies) and the corpse passives are her sustain and her damage
...
| 6 | Piercing | buy max (20) | penetration (Skeletal Archer already adds some) |
...
*1–9 ≈ the 1250 budget; 10–13 take her to 1600. Note: unlike her husband (who leans on Skeletal Archer's stamina recovery and an Absorb Stamina dagger), she runs no sustain skill, so recovery stars earn their keep — keep Rejuvenation slotted, and keep the Archer summoned for its Stamina Recovery.*
...
## Notes
- **The ghost and the archer are the build.** If Spirit Guardian ever drops, re-summon it before anything else — that 10% transfer plus its heal is most of her survivability. Keep Skeletal Archer up too; it's her only stamina-recovery source on the bar.
