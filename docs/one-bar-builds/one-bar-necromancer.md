# One-Bar Necromancer Cheat Sheet
...
## How to play it
1. Before the pull: **Spirit Guardian** (ghost) up, **Blighted Blastbones** out
2. **Blighted Blastbones** → makes a corpse
3. **Detonating Siphon** → eats the corpse, her big hit
4. **Avid Boneyard** → drop it, press the **synergy** that pops up (heals her)
5. **Ricochet Skull** as filler between everything; re-cast Blastbones whenever it's back
6. **Glacial Colossus** whenever it's charged
7. Taking damage? The ghost and Pale Order are already healing her — press **Avid Boneyard's synergy** or just keep attacking; every corpse explosion heals her back through Pale Order.

**Short version:** Keep the ghost up. Make a corpse (Blastbones/Skull), eat a corpse (Siphon/Boneyard). Repeat. Colossus on cooldown.
...
| Chest | **Heavy** | Divines | Magicka | Order's Wrath |
...
| Staff (Lightning or Ice) | — | Infused | Weapon Damage | Deadly Strike |
...
- **Light Armor:** Spell Warding, Prodigy — HIGH
...
| 2 | **Thaumaturge** | **SLOT** (50) | +DoT damage — the Siphon tether and Boneyard |
...
| 9 | Blessed | buy max (20) | her heals — Grave Robber, Spirit Guardian — hit harder |
...
| 15 | Biting Aura | buy (50), swap option | boosts her AoE (Boneyard, Colossus, corpse blasts) |
...
## Notes
- **The ghost is the build.** If Spirit Guardian ever drops, re-summon it before anything else — that 10% transfer plus its heal is most of her survivability.
- **Nothing on this bar is scribed** — she never has to hunt down a non-scribed substitute.
- The corpse loop is the only thing to learn: make a corpse, eat a corpse. If she ever runs dry on corpses, Ricochet Skull's every-third-cast makes one for free.
...
**Best pick: Isobel, built Tank.** All **Heavy / Bolstered** armor; **Quickened** jewelry, 1H sword, shield. Bar order (they cast top-to-bottom as cooldowns finish): **Provoke → Solar Ward → Beam of Reproach → Holy Ground → On Guard**, Ult **Baneslayer**. She pulls aggro so she eats the hits instead of her, and holds enemies together inside the Boneyard/Corpseburster circle.
