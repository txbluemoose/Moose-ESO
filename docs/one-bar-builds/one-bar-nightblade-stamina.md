# One-Bar Stamina Nightblade Cheat Sheet
...
- **Fighters Guild:** the flat-damage passives (Slayer) — HIGH
...
**Slot (4):** Deadly Aim · Thaumaturge · Fighting Finesse · Master-at-Arms — the damage slots sit near the center, so they come first.

| # | Star | Action | What it does for HER |
|---|---|---|---|
| 1 | **Deadly Aim** | **SLOT** (50) | +single-target damage — her whole bow game |
| 2 | **Thaumaturge** | **SLOT** (50) | boosts DoT damage — Poison Injection and Endless Hail are both DoTs |
| 3 | **Fighting Finesse** | **SLOT** (50) | bigger crits (Relentless keeps her crit high) |
| 4 | **Master-at-Arms** | **SLOT** (50) | +direct damage — the spectral bow and Killer's Blade are direct hits |
...
| 14 | Wrathful Strikes | buy (50), swap option | flat damage — in for Thaumaturge on single-target-only fights |
...
| 7 | **Expert Evasion** | **SLOT** (50) | cheaper, stronger dodge rolls — her main panic button on one bar |
| 8 | Defiance | buy max | mitigation |
| 9 | Mystic Tenacity | buy max | less stun/fear time |
| 10 | Siphoning Spells | buy (50), swap option | stamina/magicka on kill — trash/delve farming |
| 11 | Pain's Refuge | buy (50), swap option | nasty-boss mitigation |
| 12 | Bloody Renewal | buy (50), swap option | resources on kills |

*1–9 ≈ the 1250 budget; 10–12 take her to 1600.*
...
**Best pick: Isobel, built Tank.** All **Heavy / Bolstered** armor; **Quickened** jewelry, 1H sword, shield. Bar order (they cast top-to-bottom as cooldowns finish): **Provoke → Solar Ward → Beam of Reproach → Holy Ground → On Guard**, Ult **Baneslayer**. She pulls aggro so she eats the hits, and stuns are far less dangerous when something else holds the boss while the wife shoots from the back.
