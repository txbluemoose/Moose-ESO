# One-Bar Stamina Templar Cheat Sheet
### The "Jab and Stand in the Circle" Build — One Bar, Melee but Self-Healing, No Scribing

**Character:** Stamina Templar, pure class (no subclass — uses Class Mastery)
**Verified against:** Hyperioxes One-Bar / Solo Stamina Templar Solo build for U50 (Jabs spammable + Judgment's Brand; soloed vet HM Cradle of Shadows). This is the **Stamina sibling** of her [One-Bar Magicka Templar cheat sheet](one-bar-templar.md) — same class, same masteries, weapon and stat pool swapped.
...
> **Note on the spammable's heal:** Biting Jabs itself grants Major Brutality/Sorcery + Minor Berserk — it does **not** lifesteal. The healing on this bar is *layered* (Ritual tile, Honor the Dead, Bastion of Light, Radiant Glory execute, Pale Order). If she wants the spammable *itself* to heal, the one-button swap is **Puncturing Sweep** (same base skill) — it heals 25% of the damage it does, trading the weapon/spell-damage buff for raw lifesteal. For her survivability-first profile that swap is completely legitimate; the Jabs version below just parses a little higher.

---

## Skills — One Bar (Dual Wield)

1. **Biting Jabs** (morph of Puncturing Strikes, *Aedric Spear*) — THE button. Melee spear cone, hits up to 6, grants her **Major Brutality + Major Sorcery** (weapon/spell damage) and **Minor Berserk**, and feeds the Judgment's Brand mastery. Her spammable and her damage buff in one. *(Swap to **Puncturing Sweep** if she wants heal-on-hit instead — see the note above.)*
2. **Power of the Light** (morph of Backlash, *Dawn's Wrath*) — big delayed-blast damage that applies **Sundered** (100 Weapon/Spell Damage back to her) and procs **Illuminate → Minor Sorcery** just for being on her bar.
...
5. **Solar Barrage** (morph of Solar Flare, *Dawn's Wrath*) — an AoE DoT that **follows her** and grants **+5% damage done with class abilities** (buffs Jabs, Power of the Light, the ult). Also counts as Sacred Ground for the mastery heal.
- **Ult: Solar Prison** (morph of Nova, *Dawn's Wrath*) — drops a **Major Maim** zone (enemies deal ~10% less) plus a stun. Her "survive this pull" button. *(Prefer a healing ult? **Everlasting Sweep** (morph of Radial Sweep, *Aedric Spear*) heals her and keeps the mastery Sacred Ground alive — a fine swap.)*

*Nothing here is scribed — Templar needs no scribing, which suits her perfectly. Every skill is a class or weapon skill she can cast straight off her bar. **Want Major Resolve (armor)?** Swap Solar Barrage → **Channeled Focus** (morph of Restoring Focus, *Restoring Light*) — it drops a rune for armor + stamina recovery, the tankier choice for nasty bosses.*

### Class Mastery (pure class — pick 2)
- **Judgment's Brand** — every time Burning Light procs off her Biting Jabs, her Templar abilities gain a flat chunk of damage for ~3 seconds. Near-permanent uptime — it's why Jabs is the strongest one-bar spammable.
- **Bastion of Light** — while Sacred Ground is active (her Ritual of Retribution, her Solar Barrage) she heals ~1498 Health every second, and hitting full health in combat banks 2 Ultimate. This is the automatic heartbeat heal that turns "stand in the circle" into "cannot die."

*Both verified vs ESO-Hub / Alcast U50 Class Mastery lists. In-game tooltips override — confirm the numbers on her bar.*
...
3. **Power of the Light** on the boss (big delayed hit + her damage buffs)
4. **Biting Jabs** over and over from inside the circle
5. Below ~25% HP, **Power of the Light** stays great, and if she wants a hard finisher she can slot Radiant Glory (see Notes)
...
**Short version:** Drop the Ritual circle, refresh Solar Barrage and Power of the Light when they fade, hold Biting Jabs from inside the circle, Honor the Dead if health dips, Solar Prison when a pull gets scary.
...
| Chest | Medium | Divines | Stamina | Order's Wrath |
...
| Boots | **Heavy** | Reinforced | Stamina | Deadly Strike |
...
*Both sets are within reach today — **Order's Wrath** is craftable at her husband's station, and **Deadly Strike** is cheap from guild traders (Cyrodiil set) — and she already owns it. No grind. **Deadly Strike** (boots + 2 jewelry + 2 daggers = 5) boosts damage-over-time and channeled abilities by 15%, and Biting Jabs is a channel while Ritual / Solar Barrage are DoTs — it's built for this bar. **Order's Wrath** (5 body) is flat crit. In-game tooltips override — confirm on her bar.*
...
- **Dawn's Wrath** (Power of the Light, Solar Barrage) — all 4; **Illuminate** (Power of the Light procs it → Minor Sorcery) and Restoring Spirit (cheaper abilities = sustain) — HIGH
...
- **Undaunted:** Undaunted Mettle — her 5/1/1 pays out fully — HIGH
...
|---|---|---|---|
| 1 | **Biting Aura** | **SLOT** (50) | Biting Jabs is an AoE cone — this boosts all of it |
| 2 | **Master-at-Arms** | **SLOT** (50) | +direct damage on Jabs and Power of the Light |
...
| 9 | **Blessed** | buy max (20) | **all her heals hit harder** — Ritual, Honor the Dead, Bastion, Pale Order |
...
| 14 | Thaumaturge | buy (50), swap option | boosts her DoTs (Ritual, Solar Barrage, Power of the Light) |
| 15 | Deadly Aim | buy (50), swap option | single-target swap for big bosses (in for Biting Aura) |
| 16 | Ironclad | buy (50), swap option | when a boss hits like a truck |
...
| 2 | **Fortified** | **SLOT** (50) | armor (matters more here — no Channeled Focus on the base bar for Major Resolve) |
| 3 | **Rejuvenation** | **SLOT** (50) | resource recovery — she has no sustain skill, so this earns its slot |
...
| 13 | Bracing Anchor | buy (50), swap option | block-heavy fight swap |
...
*Source: Hyperioxes One-Bar / Solo Stamina Templar build U50 (Jabs + Judgment's Brand; soloed vet HM Cradle of Shadows). Skill morphs and lines verified vs ESO-Hub / UESP U50 tooltips — Solar Barrage confirmed as a morph of Solar Flare (Dawn's Wrath), Solar Prison as a morph of Nova, Biting Jabs and Puncturing Sweep as the two morphs of Puncturing Strikes. Class Mastery vs ESO-Hub / Alcast U50. In-game tooltips override any guide. Revision date: 2026-08-16.*
...
**Best pick: Isobel, built Tank.** All **Heavy / Bolstered** armor; **Quickened** jewelry, 1H sword, shield. Bar order (they cast top-to-bottom as cooldowns finish): **Provoke → Solar Ward → Beam of Reproach → Holy Ground → On Guard**, Ult **Baneslayer**. She pulls aggro so she eats the hits instead of her — which matters more on a melee build, since it lets the wife jab from the circle without becoming the target.
